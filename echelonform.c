...

{
   ...
   katsayi1=(matris[1][0])/(matris[0][0]); //katsayý ki bu sayý ile 0 yapýcaz.
      ...
      matris[1][0]=((matris[0][0])*katsayi1)-matris[1][0]; //bu iþlemde ise 2.satýrýn 1. elemanýný sýfýr yapýyoruz.
	...
	printf("\nkatsayi2  %f  \n",katsayi2);
	matris[2][0]=((matris[0][0])*katsayi2)-matris[2][0]; //ayný iþlemler 3.satýrýn ilk elemanýný 0 yapmak için
	...
	printf("\nkatsayi3  %f\n",katsayi3);
	matris[2][1]=((matris[1][1])*katsayi3)-matris[2][1]; //3. satýrýn ikinci elamanýn 0 yapma iþlemi//
